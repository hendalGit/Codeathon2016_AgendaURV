...
public class Crai extends Activity {
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.select_dialog_item, llistacampus);
        ListView listprofesview = (ListView) findViewById(R.id.llistacampusView);
